...
from .models import Especialidades, Dados_Medico, is_medico, DatasAbertas
...
def cadastro_medico(request):
    ...
    if is_medico(request.user):
        messages.add_message(request, constants.WARNING, 'você ja é medico')
...
def abrir_horario(request):
    ...
    if request.method == 'GET':
        dados_medicos = Dados_Medico.objects.get(user=request.user)
